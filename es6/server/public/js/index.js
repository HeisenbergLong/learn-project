...
/***/ (function(module, exports) {
	...
	*****/
	{
	     ...
	     **/
	    {
	        var s = 'bbbb_bb_b';
	        var a1 = /b+/g;
	        var a2 = new RegExp('b+', 'y'); //都是全局匹配，y匹配：紧跟上一次匹配其后进行当前匹配，中间不能有其他的间隔；本例中：bbbb之后有一个‘_’，所以匹配失败
	...
	**/
	...
	//map set 数组：增|查|改|删
	{
	    ...
	    var _m = map.has('a');
	    var _s = set.has({ a: 1 });
	    var _a7 = _arr.find(function (i) {
	        return i.a ? i : '';
	    });

	    //改
	    _m = map.set("a", 2);
	    _a7 = _arr.forEach(function (i) {
	        return i.a ? i.a = 2 : '';
	    });
	    _s = set.forEach(function (i) {
	        return i.a ? i.a = 2 : '';
	    });
	    ...
	    set.forEach(function (i) {
	        return i.a ? set.delete(i) : '';
	    });
	    var _index3 = _arr.findIndex(function (i) {
	        return i.a;
	    });
	    _arr.splice(_index3, 1);
	}
